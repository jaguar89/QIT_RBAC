            ...
            <div class=" p-6 rounded-lg ">
                ...
                <form wire:submit.prevent="submit" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" id="image" wire:model.defer="image" name="image" class="mt-1 p-2 w-full border rounded-md">
                    </div>

                    <!-- Category Name -->
                    <div class="mb-4">
                        <label for="category_name" class="block text-sm font-medium text-gray-600">Category Name:</label>
                        <input type="text" id="name" wire:model="name" name="name" class="mt-1 p-2 w-full border rounded-md">
                    </div>

                    <!-- Parent Category -->
                    <div class="mb-4">
                        <label for="parent_category" class="block text-sm font-medium text-gray-600">Parent Category:</label>
                        <select id="parent_category" wire:model="parent_id" name="parent_id" class="mt-1 p-2 w-full border rounded-md">
